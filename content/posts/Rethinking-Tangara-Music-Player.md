...
project. I found [this review of Tangara's design](https://halestrom.net/darksleep/blog/053_tangara/) very interesting and educational.
...
While the `CJMCU-4344 DAC module` works pretty well, the underlying CS4344 chip
has been discontinued by Cirrus Logic. We now use a TI PCM5102A DAC module, and
it works even better. TI TAD5242 (DAC with headphone driver) sounds amazing
too, but its QFN package can be problematic. For now, TI PCM5102A serves us
well and seems to "beat" WM8523 on paper.
