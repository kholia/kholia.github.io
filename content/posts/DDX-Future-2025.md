...
- Make the hardware part free (Free an in Freedom). The users will be able to order fully assembled boards from JLCPCB or other vendors on their own.
...
Antenna ➔ RX path ➔ SMD BPF (7 to 28) ➔ CD2003 with AGC ON ➔ Small "emergency" 10k SMD pot to tweak volume one time ➔ MCP6022 (fixed 20 to 22X gain, MFB with LPF action) ➔ RP2350 2's ADC
