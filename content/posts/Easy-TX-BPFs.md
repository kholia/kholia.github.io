...
The files for this project are [published here](https://github.com/kholia/DDX/tree/master/RX-TX-BPF-2025-v2) for personal (non-commercial) usage.
...
Special thanks goes to [VU2SPF](https://vu2spf.blogspot.com/) for all his help!
