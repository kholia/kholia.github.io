...
The first law of thermodynamics states that total energy of an isolated system is constant, energy can neither be created nor be destroyed but can be transformed from one form to another. We do not want to break it ;)
