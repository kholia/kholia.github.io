...
By sampling the Si4732's SSB output using the STM32H562RGT6 ADC and exposing the samples to the host via a "virtual" USB UAC-2 device, we get the following RX results:
