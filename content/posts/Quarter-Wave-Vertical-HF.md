...
![WSPR Results](/images/WSPR-2026-2.png)
...
Even in a space-constrained first-floor balcony, it was trivial to tune the
antenna by just folding back some wire.

![NanoVNA SWR results 1](/images/NanoVNA-Antenna-1.bmp)

![NanoVNA SWR results 2](/images/NanoVNA-Antenna-2.bmp)
