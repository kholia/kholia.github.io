...
The [wspr_spread](https://github.com/rxt1077/wspr_spread) work is excellent.
...
This is quite spread out, but we are operating on 2m, so this is probably
expected for a 25 MHz TCXO-based system.

## Comparison

A better WSPR generator would produce something like this ([dissecting_wsprd sample](https://github.com/rxt1077/dissecting_wsprd)):

![WSPR Spread Proper](/images/W3HH_region_of_interest.png)

We will get there at a low cost eventually ;)

Update: Based on [W3HH on QRZ](https://www.qrz.com/db/W3HH), this sample
recording appears to be from the 30m or 10m band. This explains the "low/tight
doppler spread" value for W3HH.

## References

- [wspr_spread](https://github.com/rxt1077/wspr_spread)

- [dissecting_wsprd](https://github.com/rxt1077/dissecting_wsprd)
