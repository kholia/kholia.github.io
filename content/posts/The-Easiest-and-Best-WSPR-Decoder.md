...
% curl http://rpi.local:8080/health
{
  ...
  "selected_bands": ["20m", "15m", "40m", "17m"],
  "exploration_slot": false,
  "reporting_enabled": true,
  "reporting_network": "PSK Reporter",
  "report_queue_depth": 28,
  "frames_decoded": 4754,
  "spots_decoded": 11775,
  "decoder_errors": 0,
  "last_decodes_ft8lib": 5,
  "last_decodes_jt9": 6,
  "total_decodes_ft8lib": 6794,
  "total_decodes_jt9": 11319,
  "frames_decoded_ft8lib": 4754,
  "frames_decoded_jt9": 4754,
  "average_decodes_ft8lib": 1.43,
  "average_decodes_jt9": 2.38,
  "airspy_overrun_samples": 0,
  "dsp_queue_overrun_samples": 0,
  "started_unix": 1787416848,
  "uptime_seconds": 71342,
  "last_decode_unix": 1787488176,
  "last_spot_unix": 1787488176,
  "version": "0.9"
}
```

My results with almost a `wet noodle` antenna:

![On-air FT8 demo](/images/WSPR-RX-demo-4.png)

In contrast, here is what the best parallel RX station in India looks like:

![VU2CPL RX results](/images/VU2CPL-Best-Station-1.png)

My station receives 116 countries and VU2CPL's station receives 141 countries
in 24 hours or so!
