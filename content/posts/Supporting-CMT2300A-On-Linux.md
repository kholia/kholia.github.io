...
This is aimed at embedded Linux developers, reverse engineers, and RF hackers. It is *not* a beginner Linux kernel tutorial nor a full CMT2300A datasheet walkthrough; the focus is on practical bring-up and reproducibility.
...
Within IDA Pro, we first locate register bank tables by looking for known
patterns of register writes found in other CMT2300A open-source repos (e.g.,
GitHub CMT2300A projects).
...
https://renode.io/ is excellent. One idea is to run the extracted Tapo S200B
firmware under Renode. So far, we have had limited success with this approach.
...
Note: Stay tuned; more updates are on the way for this page.
...
We can now generate valid key-press events from our custom hardware platform.
