...
It turns out that the `Orange` branded 12V 2A or 3A adapters from Robu are really trash. The output voltage drops to less than 2V when the load current is increased to around 1A. This is NOT the first time that the `Orange` branded stuff has turned out to be of poor quality. In the end, you get what you pay for.
